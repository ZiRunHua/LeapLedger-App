...
TransactionEditModel _$TransactionEditModelFromJson(Map<String, dynamic> json) => TransactionEditModel(
...
Map<String, dynamic> _$TransactionEditModelToJson(TransactionEditModel instance) => <String, dynamic>{
      'Id': instance.id,
...
TransactionInfoModel _$TransactionInfoModelFromJson(Map<String, dynamic> json) => TransactionInfoModel(
      id: (json['Id'] as num?)?.toInt() ?? 0,
      userId: (json['UserId'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$TransactionInfoModelToJson(TransactionInfoModel instance) => <String, dynamic>{
      'Id': instance.id,
      'UserId': instance.userId,
      'AccountId': instance.accountId,
      'CategoryId': instance.categoryId,
...
TransactionModel _$TransactionModelFromJson(Map<String, dynamic> json) => TransactionModel(
      ...
      remark: json['Remark'] as String? ?? '',
      tradeTime: const UtcDateTimeConverter().fromJson(json['TradeTime'] as String?),
      createTime: const UtcDateTimeConverter().fromJson(json['CreateTime'] as String?),
      updateTime: const UtcDateTimeConverter().fromJson(json['UpdateTime'] as String?),
    );
...
TransactionShareModel _$TransactionShareModelFromJson(Map<String, dynamic> json) => TransactionShareModel(
      id: (json['Id'] as num?)?.toInt() ?? 0,
      amount: (json['Amount'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$TransactionShareModelToJson(TransactionShareModel instance) => <String, dynamic>{
      'Id': instance.id,
      'UserName': instance.userName,
      'AccountName': instance.accountName,
      'IncomeExpense': _$IncomeExpenseEnumMap[instance.incomeExpense]!,
      ...
      'Amount': instance.amount,
      'Remark': instance.remark,
      'TradeTime': _$JsonConverterToJson<String?, DateTime>(instance.tradeTime, const UtcDateTimeConverter().toJson),
      'CreateTime': _$JsonConverterToJson<String?, DateTime>(instance.createTime, const UtcDateTimeConverter().toJson),
      'UpdateTime': _$JsonConverterToJson<String?, DateTime>(instance.updateTime, const UtcDateTimeConverter().toJson),
    };
...
TransactionTimingModel _$TransactionTimingModelFromJson(Map<String, dynamic> json) => TransactionTimingModel(
...
Map<String, dynamic> _$TransactionTimingModelToJson(TransactionTimingModel instance) => <String, dynamic>{
      'Id': instance.id,
      'AccountId': instance.accountId,
      'UserId': instance.userId,
